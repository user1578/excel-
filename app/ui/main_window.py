...
class MainWindow(QMainWindow):
    ...
    def _build_pages(self) -> None:
        ...
        self.class_page = ClassPage(self.service, self.data_workspace, lambda: self.navigate("workbook_fill"))
        ...
        self.merge_page = MergePage(self.data_workspace, self.service)
